...
setLoading(true)
if(word!='')
axios.get("https://app-3bdk.onrender.com/file/phrases",{
  params:{
    phrase:word
  }
}).then(res=>{
...
//console.log(Object.keys(res.data[0].finalwords))
  ...
  const deleteClick=(filename)=>{
    axios.delete("https://app-3bdk.onrender.com/file/delete",{
      params:{
  ...
  const sortFileName=()=>{
    setFileList([])
    if(word!=''){
axios.get("https://app-3bdk.onrender.com/byfileName",{
  params:{
    word:word
  }
}).then(res=>{
...
axios.get("https://app-3bdk.onrender.com/file/get").then(res=>{
console.log(typeof(res.data),typeof(filelist))
setFileList(res.data)
setLoading(false)
...
axios.get("https://app-3bdk.onrender.com/file/sortYear",{
params:{
  phrase:word
}
}).then(res=>{
